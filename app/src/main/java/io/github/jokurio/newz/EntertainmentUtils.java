...
import static io.github.jokurio.newz.EntertainmentFragment.LOG_TAG;

public class EntertainmentUtils {
    ...
    public static String createStringUrl() {
        ...
        builder.scheme("http")
                ...
                .appendQueryParameter("q", "entertainment")
